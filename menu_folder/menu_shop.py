...
class Menu_shop(pygame.sprite.Sprite):
  def __init__(self, eventList):
    pygame.sprite.Sprite.__init__(self)
    self.menu_name='Menu_shop'
    
    self.menu_icon_list_rect=[menu_asset.menu_shop_icon_list[0].get_rect(),
                              menu_asset.menu_shop_icon_list[1].get_rect(),
                              menu_asset.menu_shop_icon_list[2].get_rect()]
    ...
    self.menu_op_name=['buy', 'sell', 'exit']
    self.menu_op=['Menu_shop_buy', 'Menu_shop_sell', 'Menu']
  ...
  def menu_act(self):
    print(self.menu_op[self.cursor])
  ...
  def draw(self, screen):
    ...
    for j in range(0, len(menu_asset.menu_shop_icon_list)):
      screen.blit(menu_asset.menu_shop_icon_list[j],
