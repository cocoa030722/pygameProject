...
class Menu_fairy(pygame.sprite.Sprite): #다수의 변수 열람할 수 있도록 스크롤 기능 추가
  def __init__(self, eventList):
    pygame.sprite.Sprite.__init__(self)
    self.menu_name='Menu_fairy'
    self.choice_count=3
    ...
    self.menu_op_name=['call', 'relocation', 'progress']
    self.menu_op=['Menu_fairy', 'Menu_fairy', 'Menu_fairy']
